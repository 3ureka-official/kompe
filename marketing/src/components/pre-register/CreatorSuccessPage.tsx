  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FE2C55] via-[#FF0050] to-[#25F4EE] flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
        <div className="mb-6">
          <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4" style={{backgroundColor: '#25f4ee40'}}>
            <svg className="w-10 h-10" fill="none" stroke="#25f4ee" viewBox="0 0 24 24">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-6">
          <p className="text-gray-700 leading-relaxed">
            今後のご案内は<br />
            <span className="font-bold text-[#FE2C55]">3urek.official@gmail.com</span><br />
            のアドレスからメールで送信します。
          </p>
        </div>
