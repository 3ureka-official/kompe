  ...
  const faqs = [
    {
      ...
      answer:
        "はい、完全無料です！登録料、参加費、手数料など一切ありません。賞金を獲得した場合も、満額をお支払いします。",
    },
    {
      question: "動画の長さはどのくらい？",
      answer:
        "TikTokの標準に合わせて15秒〜3分以内です。企業によって希望の長さが指定される場合もありますが、基本的には自由です。",
    },
    {
      question: "何回でも応募できる？",
      answer:
    ...
    },
    {
      question: "いつ賞金もらえる？",
      answer:
        "コンテスト終了後、最終順位が確定してから5営業日以内にお振込みします。振込手数料は当社負担です。",
    },
    {
      question: "未成年でも参加できる？",
      answer:
    ...
    },
    {
      ...
      answer:
        "一切ありません！フォロワー0人でも参加OK。実際にフォロワー100人以下のクリエイターが入賞した例も多数あります。",
    },
    {
      question: "動画が審査で落ちることはある？",
      answer:
        "基本的にはありません。ただし、企業の要望と大きく異なる内容や、不適切な表現がある場合は対象外となることがあります。",
    },
    {
      question: "どうやって順位が決まるの？",
      answer:
        "TikTokの再生数もしくはエンゲージメント（再生数、いいね数、コメント数、シェア数）で評価します。全て自動集計なので公平です。",
    },
  ];
