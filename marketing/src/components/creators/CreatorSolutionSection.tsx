        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              ...
              <h3 className="text-2xl font-bold mb-4">実力勝負</h3>
              <p className="text-lg opacity-90 mb-4">フォロワー少なくてもOK</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="text-6xl mb-6">💰</div>
              <h3 className="text-2xl font-bold mb-4">確実な報酬</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
              <div className="text-6xl mb-6">🎯</div>
              <h3 className="text-2xl font-bold mb-4">作りやすい</h3>
              <p className="text-lg opacity-90 mb-4">企業からの明確な指示</p>
              <ul className="text-left space-y-2 opacity-80">
                <li>• 素材も提供される</li>
                <li>• 何を作ればいいか明確</li>
                <li>• 制作サポートも充実</li>
