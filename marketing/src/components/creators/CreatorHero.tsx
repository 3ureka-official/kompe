        ...
        <div className="max-w-4xl mx-auto pt-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a
              ...
              className="cursor-pointer bg-white text-[#FE2C55] px-10 py-5 rounded-full font-bold text-xl hover:bg-gray-100 transition-colors shadow-2xl text-center inline-block"
            >
              事前登録はこちら
            </a>
