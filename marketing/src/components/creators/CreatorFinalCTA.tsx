        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-[2vw] xl:mb-10 flex justify-center items-center gap-[2vw] xl:gap-0">
            ...
            <div className="flex flex-col gap-0 xl:gap-4">
              <h3 className="text-[3.5vw] md:text-[3vw] xl:text-3xl font-bold text-white">
                あなたの動画が、きっと誰かの心を動かします。
              </h3>
              <h3 className="text-[3.5vw] md:text-[3vw] xl:text-4xl font-bold text-white">
                今すぐコンテストに参加しよう
              </h3>
            </div>
          ...
          <div className="flex flex-col gap-4 justify-center w-[50vw] xl:max-w-md mx-auto">
            <a
              ...
              className="cursor-pointer bg-white text-[#FE2C55] px-[2vw] py-[2vw] xl:px-10 xl:py-5 rounded-full font-bold text-[2.8vw] md:text-[2vw] xl:text-2xl hover:bg-gray-100 transition-colors shadow-2xl text-center"
            >
              今すぐ始める
            </a>
          </div>
