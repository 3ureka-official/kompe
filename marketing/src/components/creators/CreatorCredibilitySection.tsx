        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-[#FE2C55] mb-2">
                100+
              </div>
              <div className="text-gray-600 font-medium">参加クリエイター</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-[#25F4EE] mb-2">
                500万円+
              </div>
          ...
          <div className="bg-gradient-to-r from-[#FE2C55] to-[#25F4EE] text-white p-8 rounded-2xl text-center">
            <h3 className="text-2xl font-bold mb-4">🎉 次はあなたの番です</h3>
