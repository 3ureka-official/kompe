  ...
  const caseStudies = [
    {
      ...
      testimonial:
        "想定を大きく上回る反響で、新商品の認知度が一気に向上しました。特に若年層へのリーチ力が圧倒的でした。",
    ...
    },
    {
      ...
      testimonial:
        "クリエイターの皆さんの創造性により、私たちが考えもしなかった素敵なコーディネートが多数生まれました。",
    ...
    },
    {
      ...
      testimonial:
        "多様な食べ方提案で商品の魅力を多角的に伝えることができ、売上に直結する結果となりました。",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-12">
            {caseStudies.map((study, index) => (
              ...
              >
                <div
                  className={`bg-gradient-to-r ${study.bgColor} text-white p-8`}
                >
