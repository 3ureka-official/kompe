      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700 mb-2">ブランド紹介</p>
        ...
        {/* 連絡先・SNS情報 */}
        <div>
          <h3 className="text-base font-medium text-gray-700 mb-4">連絡先・SNS</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span className="text-sm text-gray-600">contact@abc-corp.com</span>
            </div>
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://twitter.com/abc_corp" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover:text-blue-800">
                @abc_corp
              </a>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a href="https://instagram.com/abc_corp" target="_blank" rel="noopener noreferrer" className="text-sm text-pink-600 hover:text-pink-800">
                @abc_corp
              </a>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a href="https://abc-corp.com" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover:text-blue-800">
                abc-corp.com
              </a>
            </div>
          </div>
