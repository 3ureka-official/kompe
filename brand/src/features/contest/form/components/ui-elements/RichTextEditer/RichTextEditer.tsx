// features/contest/create/components/ui-elements/RichTextEditer/RichTextEditer.tsx
"use client";
...
function isMarkdownStorage(v: unknown): v is MarkdownStorage {
  return (
    typeof v === "object" &&
    v !== null &&
    typeof (v as { getMarkdown?: unknown }).getMarkdown === "function"
  );
}

function getMarkdown(editor: Editor): string {
  const storage = editor.storage as unknown as Record<string, unknown>;
  const maybe = storage["markdown"];
  return isMarkdownStorage(maybe) ? maybe.getMarkdown() : "";
}
