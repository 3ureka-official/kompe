...
interface UpdateBrandFormProps {
  control: ReturnType<typeof useUpdateBrandForm>["control"];
  handleSubmit: ReturnType<typeof useUpdateBrandForm>["handleSubmit"];
  onSubmit: ReturnType<typeof useUpdateBrandForm>["onSubmit"];
  isPending: boolean;
  error: ReturnType<typeof useUpdateBrandForm>["error"];
  logoFile: File | null;
