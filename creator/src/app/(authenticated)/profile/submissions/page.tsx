...
export default function SubmissionsPage() {
  ...
  const loadMore = async () => {
    ...
    try {
      ...
      const submissionsData = await ProfileService.getUserSubmissions(
        user.id,
        nextPage,
        10,
      );
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-primary-600">
                        ¥{formatNumber(stats.totalPrizeAmount)}
                      </p>
                    </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>最新の応募から順に表示されます</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-shrink-0">
                          <Image
                            src={
                              submission.contestThumbnailUrl ||
                              "/placeholder-contest.jpg"
                            }
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {submission.metrics && (
                            <div className="flex items-center gap-4 mb-3">
                              ...
                              <div className="text-sm text-gray-600">
                                エンゲージメント率:{" "}
                                {submission.metrics.engagementRate.toFixed(1)}%
                              </div>
                            </div>
                          )}
                            ...
                            {submission.finalScore && (
                              <div className="text-sm">
                                ...
                                <span className="font-medium">
                                  {formatNumber(submission.finalScore)}
                                </span>
                              </div>
                            )}
                            {submission.prizeAmount && (
                              <div className="text-sm">
                                ...
                                <span className="font-medium text-green-600">
                                  ¥{formatNumber(submission.prizeAmount)}
                                </span>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-600">
                            ...
                            {submission.approvedAt && (
                              <span>
                                承認日: {formatDate(submission.approvedAt)}
                              </span>
                            )}
                          </div>
                        </div>
